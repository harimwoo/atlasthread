...
export declare class CommentsController {
    ...
    create(createCommentDto: CreateCommentDto): Promise<Omit<import("mongoose").Document<unknown, {}, import("./schemas/comment.schema").Comment> & import("./schemas/comment.schema").Comment & {
